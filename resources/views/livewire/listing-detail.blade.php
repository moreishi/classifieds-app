            ...
            <aside class="space-y-4">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                    ...
                    <div class="flex items-center gap-2">
                        {{-- Facebook --}}
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($listingUrl) }}"
                           target="_blank"
                           rel="noopener noreferrer"
                           class="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 bg-[#1877F2] text-white rounded-lg text-xs font-semibold hover:bg-[#166fe5] transition-colors">
                        ...
                        {{-- Twitter/X --}}
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($listing->title . ' — ₱' . number_format($listing->price / 100) . ' on Iskina.ph') }}&url={{ urlencode($listingUrl) }}"
                           target="_blank"
                           rel="noopener noreferrer"
                           class="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 bg-black text-white rounded-lg text-xs font-semibold hover:bg-gray-800 transition-colors">
                        ...
                        <button x-data="{ copied: false }"
                                x-on:click="navigator.clipboard.writeText('{{ $listingUrl }}'); copied = true; setTimeout(() => copied = false, 2000)"
                                class="flex-1 flex items-center justify-center gap-1.5 py-2 px-3 bg-gray-100 text-gray-700 rounded-lg text-xs font-semibold hover:bg-gray-200 transition-colors">
            ...
            <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
                ...
                <div class="bg-white rounded-2xl shadow-xl max-w-lg w-full mx-4 p-6">
                    ...
                    <div class="flex items-center gap-3 mb-4 p-3 bg-gray-50 rounded-xl">
                        ...
                        <div>
                            <p class="font-medium text-gray-900">{{ $seller->publicName() }}</p>
